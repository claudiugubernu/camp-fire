...
type CheckInState = "loading" | "success" | "already_done" | "not_yet" | "invalid";
      ...
      <AnimatePresence mode="wait">
        ...
        {checkInState === "success" && day && (
          ...
          >
            ...
            <Card className="bg-fire-900/10 border-fire-800/30 text-left">
              ...
              <p className="text-fire-400 text-xs font-bold">— {day.verseRef}</p>
            </Card>
        ...
        {checkInState === "not_yet" && day && (
          ...
          >
            <span className="text-7xl">⏳</span>
            <div>
              <h1 className="text-2xl font-black text-text-primary">Not yet!</h1>
              <p className="text-text-secondary mt-1">
        ...
        {checkInState === "invalid" && (
          ...
          >
            <span className="text-7xl">❓</span>
            <div>
              <h1 className="text-2xl font-black text-text-primary">Invalid code</h1>
              <p className="text-text-secondary mt-1">
                This doesn't match any camp day. Make sure you're scanning the right QR code.
              </p>
            </div>
            <Button size="lg" onClick={() => navigate("/scan")}>Scan again</Button>
          </motion.div>
        )}
      </AnimatePresence>
    </div>
